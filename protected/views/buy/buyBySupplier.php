...
Yii::app()->clientScript->registerScriptFile(Yii::app()->baseUrl . "/js/buy/order-buy-supplier.js", CClientScript::POS_END);
?>
<div class="page-content">
    <div class="page-header">
        <h1>
            采购单
            <small>
                共<code id="total-num"><?php echo $totalNum; ?></code>件商品，<code id="total-supplier"><?php echo count($totalSupplier); ?></code>家供应商
                &nbsp;<i class="normal-icon icon-eye-open green bigger-130"></i>
                当前汇率：<?php echo Yii::app()->params['exchangeTax']; ?>
            </small>
        </h1>
    </div><!-- /.page-header -->
    <div class="row bs-callout bs-callout-info" style="height: 90px;">
        <div class="widget-main">
            <form class="form-inline">
                ...
                <div class="form-group">
                    <select class="chosen-select" id="form-field-select" data-placeholder="选择供应商" name="supplier">
                ...
                <div class="form-group">
                    <input type="text" placeholder="新增供应商" name="new-supplier">
                </div>
                <button class="btn btn-sm btn-success" type="button" onclick="add_new_supplier();">
                    确定
                    ...
                    <div class="dd" id="nestable" style="width:100%;max-width:none">
                        <ol class="dd-list">
                            ...
                            foreach ($goods as $key => $val) {
                                $i++;
                                ?>
                                <li class="dd-item dd-item-father" data-id="<?php echo ($i + 1); ?>" supplier-id-father="<?php echo $val['suppliers_id'] ?>">
                                    <div class="dd-handle btn-info">
                                        <span class="supplier-name"><?php echo $val['name']; ?></span>
                                        &nbsp;<span class="badge badge-info">共<?php echo count($val['items']); ?>种</span>
                                        <?php if (!empty($val['suppliers_id']) && ctype_digit($val['suppliers_id'])) { ?>
                                            <div class="pull-right action-buttons">
                                                <a class="red" href="javascript:" supplier-id="<?php echo $val['suppliers_id'] ?>" onclick="add_order_number(this);">
